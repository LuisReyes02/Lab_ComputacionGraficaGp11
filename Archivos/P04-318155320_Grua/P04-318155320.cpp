...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = modelaux;
		//Llanta 1
		model = glm::translate(model, glm::vec3(-3.5f, -1.5f, -2.3f));
		...
		meshList[2]->RenderMeshGeometry(); // Renderiza el cilindro en la posición especificada
		...
		model = modelaux;
		// Brazo 1
		model = glm::translate(model, glm::vec3(-1.75f, 1.75f, 0.0f));
